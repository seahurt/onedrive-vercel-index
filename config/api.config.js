...
module.exports = {
  ...
  clientId: process.env.MSAPP_ID || '52db70be-bcf7-49d2-8c0c-6b147fbe3a21',
  obfuscatedClientSecret: process.env.MSAPP_KEY || 'Pi68Q~pbwPjEWctH6suV3.KgOtWKdp41M6y55b1S',
