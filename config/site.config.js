...
module.exports = {
  ...
  footer:
    'Powered by <a href="https://github.com/seahurt/onedrive-vercel-index" target="_blank" rel="noopener noreferrer">onedrive-vercel-index</a>. Made with ❤ by Seahurt(fork from SpencerWoo).',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/seahurt/onedrive-vercel-index',
    },
  ],
